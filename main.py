...
def info(message):
    """Функция вывод информацию о проекте"""
...
def name_project(message):
    """Добавление названия для проекта и ссылки"""
    name = message.text
...
def link_project(message, data):
    """Вывод возможных статусов для проекта"""
...
def skill_handler(message):
    """Вывод возможных скилов для проекта"""
    user_id = message.from_user.id
...
def skill_project(message, projects):
    """Получение названия проекта от пользователя и выбор навыка для проекта"""
...
def set_skill(message, project_name, skills):
    """Получение навыка от пользователя"""
    skill = message.text
    user_id = message.from_user.id
    if message.text == cancel_button:
        cansel(message)
...
def callback_query(call):
    """Получение название проекта от пользователя"""
...
def update_project_step_2(message, projects):
    """Обновление информации о проекте, шаг второй: выбор проекта"""
    project_name = message.text
    if message.text == cancel_button:
        cansel(message)
        return
...
def update_project_step_3(message, project_name):
    """Обновление информации о проекте, шаг 3: название проекта"""
...
def update_project_step_4(message, project_name, attribute): 
    """Обновление информации о проекте 4 шаг"""
